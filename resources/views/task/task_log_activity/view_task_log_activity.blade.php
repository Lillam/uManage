...
@section('body')
    <div class="task_log_activity">
        ...
        <div class="navigation task_log_activity_header">
            <div class="uk-flex">
                <div class="uk-width-expand uk-flex uk-flex-middle">
                    <span class="task_log_activity_title">Task Activity</span>
                </div>
                <div class="uk-width-auto">
                    <a class="uk-icon-button"><i class="fa fa-info-circle"></i></a>
                </div>
            </div>
        </div>
        <div class="task_logs">
                    ...
                    <div class="task_log_content uk-width-expand@m">
                        ...
                        <div class="uk-flex task_log_created_by">
                            <div class="uk-width-expand">
                                <p>{!! \App\Printers\User\UserPrinter::userBadge($task_log->user) !!} {{ $task_log->user->getFullName() }} @ {{ $task_log->when->format('d/m/Y @ H:i') }}</p>
                            </div>
                            <div class="uk-width-auto">
