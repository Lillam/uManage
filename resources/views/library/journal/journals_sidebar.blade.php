...
<a class="{{ ($vs->is_page)('page.journals.dashboard') }}" href="{{ route('journals.dashboard') }}">
    <i class="fa fa-chart-pie"></i>{{ __('journal.sidebar.daily.dashboard') }}
</a>
<a class="{{ ($vs->is_page)('page.journals.calendar') }}" href="{{ route('journals.calendar') }}">
...
<a class="{{ ($vs->is_page)('page.journals.report') }}" href="{{ route('journals.report') }}">
...
<a class="{{ ($vs->is_page)('page.journals.dreams.dashboard') }}" href="{{ route('journals.dreams.dashboard') }}">
...
<a class="{{ ($vs->is_page)('page.journals.finances.dashboard') }}" href="{{ route('journals.finances.dashboard') }}">
    <i class="fa fa-chart-pie"></i>{{ __('journal.sidebar.finance.dashboard') }}
</a>
<a class="{{ ($vs->is_page)('page.journals.finances.calendar') }}" href="{{ route('journals.finances.calendar') }}">
