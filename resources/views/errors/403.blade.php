...
<div class="error-message uk-width-1-3 uk-flex uk-flex-center uk-flex-middle">
    <div>
        ...
        <hr/>
        <p>Unfortunately, my good sir, you do not have the permissions to view this, you may want to check out the
            store, get yourself the access to this particular portion of the system, if you don't really care, then feel
            free to trape back to where you came from, foo.</p>
        <a href="" class="uk-button"><i class="fa fa-arrow-left"></i></a>
        <a class="uk-button"
           href="{{ action([\App\Http\Controllers\Web\Store\StoreProductController::class, '_viewStoreProductsGet']) }}"
        >Store</a>
    </div>
</div>
