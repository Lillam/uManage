...
* @param direction
*/
const viewTimeLogReport = function (direction = null) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            setupChart('time_log_report_by_project', 'bar', {
            ...
            setupChart('time_log_report_by_task', 'bar', {
            ...
            setupChart('time_log_report_by_day', 'bar', {
